############################################################
#.OUTPUT_Type CSV
#.OUTPUT_Name ProcessModules.csv
#
#.SYNOPSIS
# Enumerates all running processes and their loaded modules.
#
#.DESCRIPTION
# For each process it enumerates every module and hashes the file.
#
#.NOTES
# Minor modifications made to kansa
# License: Apache License 2.0
# Credits: https://github.com/davehull/Kansa/blob/master/Modules/Process/Get-ProcsNModules.ps1
############################################################
